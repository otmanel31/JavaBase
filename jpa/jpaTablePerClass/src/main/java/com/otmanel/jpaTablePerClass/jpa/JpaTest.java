package com.otmanel.jpaTablePerClass.jpa;
...
import com.otmanel.jpaTablePerClass.beans.*;
...
public class JpaTest {
	...
	public static void test1(EntityManagerFactory emf)
	{
		...
		for (int i = 0; i<=10; i++) {
			//em.persist(new Client(UUID.randomUUID().toString(), "anrold"+i, "willy"+i, "arnold"+i +"@willy.com", 2000.0));
